 ...
 */
public class QrySopWand extends QrySopWithWeight {
  ...
  public double getDefaultScore(RetrievalModel r, int docId)
    ...
    for (int i = 0; i < this.args.size(); ++i) {
      ...
      score *= Math.pow(sop_i.getDefaultScore(r, docId),
          this.weights.get(i) / this.weightSum);
    }
    return score;
  }
  ...
  private double getScoreIndri (RetrievalModel r) throws IOException {
    ...
    for (int i = 0; i < this.args.size(); ++i) {
      ...
      score *= Math.pow(sopScore, this.weights.get(i) / this.weightSum);
    }
    return score;
  }
}
